...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // Signup successful - redirect directly to dashboard
        // The API already creates a session, so we can go straight to dashboard
          ...
          <CardHeader className="text-center space-y-4">
            ...
            <div>
              ...
              <CardDescription className="text-gray-600 mt-2">
                Join us and start predicting stocks with AI
              </CardDescription>
            </div>
          </CardHeader>
